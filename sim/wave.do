...
add wave -noupdate -expand -group FIFO_IN /ALU_datapath_TB/inst_fifo_sram/inst_controller/drop_packet
...
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/DWIDTH
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/AWIDTH
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/clk
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/reset_n
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/pc_en
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/i_ctrl
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/tail_addr
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/head_addr
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/wea
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/addra
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/dina
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/douta
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/fifo_sel
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/drop_packet
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/stop_tx
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/stall
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/prev_control
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/register_0
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/register_1
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/register_2
add wave -noupdate -expand -group controller /ALU_datapath_TB/inst_fifo_sram/inst_controller/register_3
...
WaveRestoreCursors {{Cursor 1} {1249707 ps} 0}
